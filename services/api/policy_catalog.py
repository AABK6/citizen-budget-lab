...
_LEVER_CATALOG: List[dict] = [
    ...
    },
    {
        ...
        "family": 'TAXES',
        "label": 'Abaissement du seuil d’application du taux d’IS minimum mondial à 500\xa0M€ de CA',
        "description": 'Abaisser de 750\xa0millions à 500\xa0millions d’euros de chiffre d’affaires le seuil à partir duquel s’applique le taux minimum mondial de 15\xa0% sur les bénéfices, élargissant ainsi le champ des entreprises concernées par ce taux plancher[22].',
        "major_amendment": True,
        "sources": ['Assemblée\xa0nat., PLF\xa02026[23]'],
        "fixed_impact_eur": 0,
        "mass_mapping": {},
        "feasibility": {'law': True, 'adminLagMonths': 6},
        "conflicts_with": [],
    ...
    },
    {
        ...
        "family": 'SOCIAL_SECURITY',
        "label": 'Limitation de la durée des arrêts de travail initiaux à 1\xa0mois',
        "description": 'Limiter la durée d’un arrêt de travail prescrit par un médecin à un maximum d’un mois pour la première prescription, et à deux mois pour chaque renouvellement. Objectif\xa0: éviter des arrêts initiaux excessivement longs et mieux encadrer les arrêts de longue durée[31].',
        "major_amendment": True,
