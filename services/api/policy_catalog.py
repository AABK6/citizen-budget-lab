...
_LEVER_CATALOG: List[dict] = [
    {
        "id": 'amend_ifi_to_fortune_improductive',
        "family": 'TAXES',
        "label": 'Remplacer l’IFI par un impôt sur la fortune improductive',
        "description": 'Suppression de l’Impôt sur la fortune immobilière (IFI) et création d’un nouvel impôt visant le patrimoine non productif (biens somptuaires, actifs non investis)[7].',
        "major_amendment": True,
        "sources": ['Assemblée\xa0nat.\xa02025, amendements PLF[7]'],
        "fixed_impact_eur": 100000000,
        "mass_mapping": {},
    ...
    },
    {
        ...
        "family": 'TAXES',
        "label": "Indexation limitée du barème de l'IR à +1,1%",
        "description": 'Revalorisation des tranches du barème de l’impôt sur le revenu de seulement +1,1% pour 2026 (soit en deçà de l’inflation prévue)[8].',
        "major_amendment": True,
        "sources": ['Assemblée\xa0nat., PLF 2026[8]'],
    ...
    {
        "id": 'amend_alimony_tax_exemption',
        "family": 'TAXES',
        "label": 'Défiscalisation des pensions alimentaires (plafond)',
        "description": 'Exonérer d’impôt sur le revenu les pensions alimentaires perçues, dans la limite de 4\xa0000\xa0€ par enfant (et 12\xa0000\xa0€ par an au total)[8].',
        "major_amendment": True,
        "sources": ['Assemblée\xa0nat., PLF 2026[9]'],
        "fixed_impact_eur": 470000000,
        "mass_mapping": {},
        "feasibility": {'law': True, 'adminLagMonths': 6},
        "conflicts_with": [],
        "params_schema": {},
    ...
    {
        "id": 'amend_home_service_credit_cap',
        "family": 'TAXES',
        "label": 'Abaissement du plafond du crédit d’impôt services à la personne',
    ...
    {
        "id": 'amend_dependence_reduction_to_credit',
        "family": 'TAXES',
        "label": 'Transformation de la réduction d’impôt dépendance en crédit d’impôt',
        "description": 'Convertir la réduction d’impôt pour dépenses liées à la dépendance (personnes âgées dépendantes) en un crédit d’impôt remboursable, afin d’en faire bénéficier même les ménages non-imposables[11].',
        "major_amendment": True,
        "sources": ['Assemblée\xa0nat., PLF 2026[11]'],
        "fixed_impact_eur": -272000000,
        "mass_mapping": {},
        "feasibility": {'law': True, 'adminLagMonths': 6},
        "conflicts_with": [],
        "params_schema": {},
    ...
    {
        "id": 'amend_extend_tips_exemption',
        "family": 'TAXES',
        "label": 'Prorogation de l’exonération fiscale des pourboires',
    ...
    {
        "id": 'amend_high_income_surtax_permanent',
        "family": 'TAXES',
        "label": 'Pérennisation de la contribution exceptionnelle hauts revenus',
    ...
    {
        "id": 'amend_return_exit_tax',
        "family": 'TAXES',
        "label": 'Rétablissement de l’Exit Tax (version antérieure à\xa02019)',
        "description": 'Réintroduire l’«\xa0Exit Tax\xa0» sur les plus-values latentes en cas d’expatriation, avec le régime antérieur à 2019 (imposition annulée seulement après 15 ans de résidence fiscale à l’étranger, contre 2 ans aujourd’hui)[14].',
        "major_amendment": True,
        "sources": ['Assemblée\xa0nat., amend.\xa0PLF[14]'],
        "fixed_impact_eur": 70000000,
        "mass_mapping": {},
        "feasibility": {'law': True, 'adminLagMonths': 6},
        "conflicts_with": [],
        "params_schema": {},
    ...
    {
        "id": 'amend_one_time_donation_exemption',
        "family": 'TAXES',
        "label": 'Don familial exceptionnel exonéré jusqu’à 152\xa0500\xa0€ en\xa02026',
        "description": 'Instaurer une exonération unique de droits de donation à hauteur de 152\xa0500\xa0€ pour les dons effectués en\xa02026 au profit d’un descendant (enfant, petit-enfant) ou conjoint[15].',
        "major_amendment": True,
        "sources": ['Assemblée\xa0nat., PLF\xa02026[15]'],
    ...
    {
        "id": 'amend_ald_sickleave_exempt_ir',
        "family": 'TAXES',
        "label": 'Maintien de l’exonération fiscale des IJ maladie (ALD)',
    ...
    {
        "id": 'amend_school_fees_tax_reduction',
        "family": 'TAXES',
        "label": 'Maintien de la réduction d’impôt pour frais de scolarité',
    ...
    {
        "id": 'amend_limit_holding_tax_to_luxury',
        "family": 'TAXES',
        "label": 'Limitation de la taxe sur les holdings patrimoniales aux biens somptuaires',
        "description": 'Restreindre l’assiette de la nouvelle taxe sur les holdings patrimoniales (sociétés non opérationnelles détenant du patrimoine) aux seuls actifs «\xa0somptuaires\xa0» (de luxe), excluant ainsi les autres biens de cette taxation[18].',
        "major_amendment": True,
        "sources": ['Assemblée\xa0nat., PLF\xa02026[18]'],
        "fixed_impact_eur": 100000000,
        "mass_mapping": {},
        "feasibility": {'law': True, 'adminLagMonths': 6},
        "conflicts_with": [],
    ...
    {
        "id": 'amend_raise_big_corp_profit_contrib',
        "family": 'TAXES',
        "label": 'Hausse de la contribution exceptionnelle sur les bénéfices des grandes entreprises',
    ...
    {
        "id": 'amend_universal_tax_multinationals',
        "family": 'TAXES',
        "label": 'Instauration d’un impôt universel sur les multinationales',
        "description": 'Mettre en place un mécanisme d’imposition universelle visant les multinationales, pour s’assurer qu’elles contribuent fiscalement en France sur leurs bénéfices mondiaux (en complément du dispositif international d’impôt minimum)[20].',
        "major_amendment": True,
        "sources": ['Assemblée\xa0nat., PLF\xa02026[20]'],
    ...
    {
        "id": 'amend_lower_global_min_tax_threshold',
        "family": 'TAXES',
        "label": 'Abaissement du seuil d’application du taux d’IS minimum mondial à 250\xa0M€ de CA',
        "description": 'Abaisser de 750\xa0millions à 250\xa0millions d’euros de chiffre d’affaires le seuil à partir duquel s’applique le taux minimum mondial de 15\xa0% sur les bénéfices, élargissant ainsi le champ des entreprises concernées (notamment les ETI).',
        "major_amendment": True,
        "sources": ['Observatoire de la Fiscalité, simulations OCDE'],
    ...
    },
    {
        ...
        "family": 'TAXES',
        "label": 'Rehaussement de la taxe sur les rachats d’actions de 8\xa0% à\xa033\xa0%',
    ...
    {
        "id": 'amend_windfall_dividend_tax',
        "family": 'TAXES',
        "label": 'Contribution sur les dividendes exceptionnels des grandes entreprises (20\xa0% à\xa033\xa0%)',
        "description": 'Instituer une contribution fiscale spécifique sur les dividendes exceptionnels versés par les grandes entreprises, à un taux situé entre 20\xa0% et\xa033\xa0%, pour faire contribuer les «\xa0super-dividendes\xa0» au budget public[25].',
        "major_amendment": True,
        "sources": ['Assemblée\xa0nat., PLF\xa02026[25]'],
        "fixed_impact_eur": 2000000000,
        "mass_mapping": {},
        "feasibility": {'law': True, 'adminLagMonths': 6},
        "conflicts_with": [],
    ...
    {
        "id": 'amend_clawback_cir_relocation',
        "family": 'TAXES',
        "label": 'Remboursement du CIR en cas de délocalisation sous 3 ans',
        "description": 'Exiger qu’une entreprise qui a bénéficié du Crédit d’impôt recherche (CIR) rembourse les trois dernières années de crédit perçues si elle délocalise ses activités de R&D hors de France, afin de décourager les délocalisations après usage du CIR[26].',
        "major_amendment": True,
        "sources": ['Assemblée\xa0nat., PLF\xa02026[26]'],
        "fixed_impact_eur": 100000000,
        "mass_mapping": {},
        "feasibility": {'law': True, 'adminLagMonths': 6},
        "conflicts_with": [],
    ...
    {
        "id": 'amend_sme_cit_threshold_100k',
        "family": 'TAXES',
        "label": 'Relèvement du seuil d’accès au taux réduit d’IS (15\xa0%) de 42\xa0500 à 100\xa0000\xa0€',
    ...
    {
        "id": 'amend_tighten_pacte_dutreil',
        "family": 'TAXES',
        "label": 'Recentrage du pacte Dutreil (biens professionnels uniquement, durée 6 ans)',
    ...
    },
    {
        ...
        "label": 'Hausse de l’Ondam 2026 portée à +3\xa0% au lieu de +1,6\xa0%',
        "description": 'Augmenter l’objectif national de dépenses d’assurance maladie (Ondam) pour 2026 à +3\xa0% (au lieu de +1,6\xa0% initialement prévu), ce qui relève le plafond de dépenses de santé à env. 273,9\xa0Md€[1].',
        "major_amendment": True,
    ...
    },
    {
        ...
        "family": 'SOCIAL_SECURITY',
        "label": 'Suspension de la réforme des retraites (report âge 64 ans suspendu)',
        ...
        "impact_schedule_eur": [-500000000, -2000000000, -4000000000, -7000000000, -10000000000],
        "mass_mapping": {'10': 1.0},
        "feasibility": {'law': True, 'adminLagMonths': 6},
        "conflicts_with": [],
        "params_schema": {},
    ...
    {
        "id": 'amend_new_birth_leave',
        "family": 'SOCIAL_SECURITY',
        "label": 'Création d’un congé de naissance supplémentaire (1 à 2 mois)',
    ...
    {
        "id": 'amend_limit_sick_leave_duration',
        "family": 'SOCIAL_SECURITY',
        "label": 'Encadrement des Indemnités Journalières (durée et plafond)',
        "description": 'Limiter la durée des arrêts de travail (max 360 jours) et abaisser le plafond de prise en charge des IJ de 1,8 à 1,4 SMIC, pour freiner la dynamique des dépenses de santé.',
        "major_amendment": True,
        "sources": ['PLFSS 2026, Rapport Commission Affaires Sociales'],
    ...
    {
        "id": 'amend_no_benefit_index_freeze',
        "family": 'SOCIAL_SECURITY',
        "label": 'Annulation du gel 2024-2025 des pensions et minima sociaux',
        "description": 'Supprimer l’article prévoyant une «\xa0année blanche\xa0» sans revalorisation des pensions de retraite et prestations sociales en avril\xa02026. Les retraites et minima sociaux seront finalement indexés sur l’inflation comme d’habitude, évitant ~3\xa0Mds€ d’économies initialement envisagées[2].',
        "major_amendment": True,
    ...
    {
        "id": 'amend_no_new_apprentice_contrib',
        "family": 'SOCIAL_SECURITY',
        "label": 'Abandon de la fin d’exonération de cotisations pour les apprentis',
    ...
    {
        "id": 'amend_no_meal_voucher_tax',
        "family": 'SOCIAL_SECURITY',
        "label": 'Abandon de la cotisation patronale sur les titres-restaurants',
    ...
    {
        "id": 'amend_no_medical_copay_doubling',
        "family": 'SOCIAL_SECURITY',
        "label": 'Renonciation au doublement des franchises médicales par décret',
        "description": 'Le gouvernement renonce à son projet d’augmenter par décret (sans vote) le montant des franchises médicales – ces participations forfaitaires laissées à charge des patients sur les boîtes de médicaments, actes médicaux, etc. Initialement, un doublement de ces franchises était envisagé[32].',
        "major_amendment": True,
        "sources": ['PLFSS\xa02026, débats[32]'],
        "fixed_impact_eur": -800000000,
        "mass_mapping": {'07': 1.0},
        "feasibility": {'law': True, 'adminLagMonths': 6},
        "conflicts_with": [],
        "params_schema": {},
    ...
    {
        "id": 'amend_raise_csg_on_capital',
        "family": 'SOCIAL_SECURITY',
        "label": 'Hausse de la fiscalité via CSG sur revenus du capital (+1,4 pt)',
        "description": 'Augmenter de 1,4 point le taux de Contribution sociale généralisée (CSG) sur certains revenus du capital (dividendes, plus-values mobilières). La CSG passe ainsi d’environ 9,2\xa0% à 10,6\xa0% sur ces revenus pour les foyers aisés, ce qui devrait rapporter ~1,5\xa0Md€ affecté à la branche autonomie[3].',
        "major_amendment": True,
    ...
    {
        "id": 'amend_surtax_health_insurers',
        "family": 'SOCIAL_SECURITY',
        "label": 'Contribution exceptionnelle des mutuelles santé (1 Md€)',
        "description": 'Instaurer une taxe exceptionnelle sur les organismes complémentaires santé (mutuelles et assureurs) d’environ 1\xa0Md€ en 2026. Objectif affiché\xa0: compenser le coût des mesures et répondre aux hausses de tarifs jugées excessives des mutuelles, sans répercussion sur les assurés (plafond d’augmentation des cotisations en 2026)[4].',
        "major_amendment": True,
    ...
    {
        "id": 'amend_extend_overtime_deduction',
        "family": 'SOCIAL_SECURITY',
        "label": 'Extension de la déduction de cotisations sur les heures sup’ aux >250 salariés',
        "description": 'Étendre aux entreprises de plus de 250 salariés la déduction forfaitaire de cotisations patronales aujourd’hui applicable aux heures supplémentaires dans les plus petites entreprises. Cette mesure, portée par des députés de l’opposition, vise à soutenir le pouvoir d’achat des salariés des grands groupes (coût <\xa0150\xa0M€)[33].',
        "major_amendment": True,
    ...
    {
        "id": 'amend_increase_severance_tax',
        "family": 'SOCIAL_SECURITY',
        "label": 'Augmentation du forfait social sur les indemnités de rupture (30% → 40%)',
        "description": 'Rehausser de 30\xa0% à 40\xa0% le taux du forfait social (contribution patronale) appliqué aux indemnités de rupture conventionnelle et de mise à la retraite. Cette mesure accroît le coût des départs négociés pour l’employeur, générant des recettes supplémentaires pour la Sécurité sociale[34].',
        "major_amendment": True,
        "sources": ['PLFSS\xa02026 adopté[34]'],
        "fixed_impact_eur": 260000000,
        "mass_mapping": {},
        "budget_side": "REVENUE",
        "feasibility": {'law': True, 'adminLagMonths': 6},
        "conflicts_with": [],
    ...
    },
    {
        ...
        "fixed_impact_eur": 6500000000,
        "mass_mapping": {'10': 1.0},
        "feasibility": {'law': True, 'adminLagMonths': 2, 'notes': 'Requires finance bill amendment; politically sensitive due to impact on households.'},
        "conflicts_with": [],
        "sources": ['Cour des comptes 2023', 'PLF 2026 orientation documents'],
        "params_schema": {},
        "dimension": 'cp',
        "impact": {'householdsImpacted': 17000000, 'decile1ImpactEur': -150, 'decile10ImpactEur': -480, 'gdpImpactPct': -0.05, 'jobsImpactCount': -2000},
    },
    {
        ...
        "mass_mapping": {'03': 1.0},
        "feasibility": {'law': False, 'adminLagMonths': 9, 'notes': 'Requires programme-by-programme redeployment; identified in PLF 2026 savings annex.'},
        "conflicts_with": [],
    ...
    },
    {
        ...
        "fixed_impact_eur": 1200000000,
        "mass_mapping": {'09': 1.0},
        "feasibility": {'law': False, 'adminLagMonths': 12, 'notes': 'Requires management reform and procurement pooling across rectorats.'},
        "conflicts_with": [],
    ...
    },
    {
        ...
        "mass_mapping": {'01': 1.0},
        "feasibility": {'law': False, 'adminLagMonths': 18, 'notes': 'Requires administrative decrees and redeployment of staff; highlighted in PLF 2026 action plan.'},
        "conflicts_with": [],
    ...
    },
    {
        ...
        "params_schema": {},
        "impact": {'householdsImpacted': 350000, 'decile1ImpactEur': 0, 'decile10ImpactEur': -12000, 'gdpImpactPct': -0.02, 'jobsImpactCount': -500},
    },
    {
    ...
    },
    {
        ...
        "params_schema": {},
        "impact": {'householdsImpacted': 0, 'decile1ImpactEur': 0, 'decile10ImpactEur': -200, 'gdpImpactPct': -0.05, 'jobsImpactCount': -2000},
    },
    {
        "id": 'end_flat_tax',
        "family": 'TAXES',
        ...
        "params_schema": {},
        "impact": {'householdsImpacted': 4000000, 'decile1ImpactEur': 0, 'decile10ImpactEur': -850, 'gdpImpactPct': -0.03, 'jobsImpactCount': -1000},
    },
    {
        "id": 'expand_ftt',
        "family": 'TAXES',
    ...
    },
    {
        ...
        "sources": ['Oxfam France [6]'],
        "params_schema": {},
        "impact": {'householdsImpacted': 25000000, 'decile1ImpactEur': -80, 'decile10ImpactEur': -250, 'gdpImpactPct': -0.1, 'jobsImpactCount': -5000},
    },
    {
        ...
        "params_schema": {},
        "impact": {'householdsImpacted': 0, 'decile1ImpactEur': 0, 'decile10ImpactEur': 0, 'gdpImpactPct': -0.08, 'jobsImpactCount': -15000},
    },
    {
    ...
    },
    {
        ...
        "sources": ['Est.'],
        "params_schema": {},
        "impact": {'householdsImpacted': 1600000, 'decile1ImpactEur': -800, 'decile10ImpactEur': -200, 'gdpImpactPct': 0.1, 'jobsImpactCount': 200000},
    },
    {
        ...
        "sources": ['BFMTV [23]'],
        "params_schema": {},
        "impact": {'householdsImpacted': 800000, 'decile1ImpactEur': 600, 'decile10ImpactEur': 2200, 'gdpImpactPct': -0.4, 'jobsImpactCount': -300000},
    },
    {
    ...
    },
    {
        ...
        "sources": ['Est.'],
        "params_schema": {},
        "impact": {'householdsImpacted': 250000, 'decile1ImpactEur': 0, 'decile10ImpactEur': -400, 'gdpImpactPct': 0.0, 'jobsImpactCount': 0},
    },
    {
        ...
        "params_schema": {},
        "impact": {'householdsImpacted': 17000000, 'decile1ImpactEur': -150, 'decile10ImpactEur': -450, 'gdpImpactPct': -0.1, 'jobsImpactCount': -2000},
    },
    {
    ...
    },
    {
        ...
        "sources": ['Le Monde [28]'],
        "params_schema": {},
        "impact": {'householdsImpacted': 2500000, 'decile1ImpactEur': -400, 'decile10ImpactEur': 0, 'gdpImpactPct': -0.05, 'jobsImpactCount': 15000},
    },
    {
    ...
    },
    {
        ...
        "params_schema": {},
        "impact": {'householdsImpacted': 3000000, 'decile1ImpactEur': -350, 'decile10ImpactEur': 0, 'gdpImpactPct': -0.05, 'jobsImpactCount': 0},
    },
    {
    ...
    },
    {
        ...
        "params_schema": {},
        "impact": {'householdsImpacted': 5700000, 'decile1ImpactEur': -200, 'decile10ImpactEur': -500, 'gdpImpactPct': -0.1, 'jobsImpactCount': 0},
    },
    {
    ...
    },
    {
        ...
        "params_schema": {},
        "impact": {'householdsImpacted': 5700000, 'decile1ImpactEur': 300, 'decile10ImpactEur': 800, 'gdpImpactPct': 0.2, 'jobsImpactCount': 5000},
    },
    {
        ...
        "params_schema": {},
        "impact": {'householdsImpacted': 50000, 'decile1ImpactEur': -50, 'decile10ImpactEur': -50, 'gdpImpactPct': -0.05, 'jobsImpactCount': -50000},
    },
    {
        "id": 'cut_agencies',
        "family": 'STAFFING',
    ...
    },
    {
        ...
        "family": 'PENSIONS',
        "label": 'Retraite : maintien du rythme de la réforme (+3 mois par an)',
        "description": "Poursuivre l'augmentation progressive de l'âge légal de la retraite de 3 mois par an pour atteindre 64 ans, comme prévu par la réforme de 2023.",
        "fixed_impact_eur": 500000000,
        "mass_mapping": {'10': 1.0},
        "feasibility": {'law': True, 'adminLagMonths': 12, 'notes': 'Gradual implementation; impact increases over time.'},
        "conflicts_with": ['pen_age_minus3m_per_year', 'amend_suspend_retirement_reform'],
    ...
    },
    {
        ...
        "sources": ['Workbook 20251017, Recettes'],
        "params_schema": {},
        "impact": {'householdsImpacted': 30000000, 'decile1ImpactEur': -250, 'decile10ImpactEur': -600, 'gdpImpactPct': -0.2, 'jobsImpactCount': -10000},
    },
    {
    ...
    },
    {
        ...
        "sources": ['Workbook 20251017, Recettes'],
        "params_schema": {},
        "impact": {'householdsImpacted': 30000000, 'decile1ImpactEur': -200, 'decile10ImpactEur': -1500, 'gdpImpactPct': -0.3, 'jobsImpactCount': -15000},
    },
    {
