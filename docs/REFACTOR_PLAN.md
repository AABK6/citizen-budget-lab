...
| **BE-04** | Model PLF 2026 policy levers ("année blanche", targeted ministry cuts) with verified fiscal impacts. | 3 | Medium | `data/policy_levers.yaml`, `schemas/policy_levers.schema.json`, `services/api/policy_catalog.py`, tests | Levers defined, applied correctly in `run_scenario`, unit tests cover impacts. | Completed |
