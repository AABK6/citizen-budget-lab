...
- UI: Three-column layout with a central treemap canvas, spending controls on the left, and revenue controls on the right. Includes a top HUD for global status and controls.
